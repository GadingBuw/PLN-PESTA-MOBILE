...
class _TechHomeState extends State<TechHome> {
  ...
  Future<List<dynamic>> fetchAllTasks() async {
    try {
      ...
      final String tomorrowStr = DateFormat(
        'yyyy-MM-dd',
          ...
          FutureBuilder<List<dynamic>>(
            ...
            builder: (context, snapshot) {
              ...
              final activeTasks = snapshot.data!
                  .where((t) => t['is_hari_ini'] == "1" || t['is_telat'] == "1")
                  .toList();
              ...
              return Column(
                ...
                children: [
                  ...
                  if (activeTasks.isEmpty)
                    _buildEmptyInfo("Tidak ada tugas aktif hari ini.")
                  else
                  ...
                  if (futureTasks.isEmpty)
                    _buildEmptyInfo("Belum ada tugas terjadwal selanjutnya.")
                  else
  ...
  Widget _buildTaskCard(Map t) {
    ...
    bool isHMinus1 =
        t['status'] == 'Menunggu Pemasangan' && t['tgl_pasang'] == tomorrowStr;
    ...
    Color themeColor = isTelat
        ...
        : (isHariIni
              ? (isBongkar
                    ? Colors.orange
                    : (isHMinus1 ? Colors.blue : Colors.green))
              : Colors.blueGrey);
